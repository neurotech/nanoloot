NanoLootWidgetsListviewMixin = {}

function NanoLootWidgetsListviewMixin:OnLoad()
...
function NanoLootWidgetsListviewMixin:OnElementInitialize(element, elementData, isNew)
    if isNew then
        element:OnLoad();
    end
    local height = self.elementHeight;
...
function NanoLootWidgetsListviewMixin:OnElementReset(element)
